...
;(function($, window, document, undefined){
	...
	OnePageNav.prototype = {
		...
		adjustNav: function(self, $parent) {
			...
			// self.$elem.find('a[href="' + $parent.find('>a').attr('href') + '"]');
			// $parent.find('>a[href="' + $(self.elem).attr['href'] + '"]');
			// console.log($parent.find('>a').attr('href'));
			$('a[href="' + $parent.find('>a').attr('href') + '"]').parent().addClass('current');
			// console.log($('a[href="' + $parent.find('>a').attr('href') + '"]').parent());

			// console.log(this.elem)

			$(self.elem).attr('data-cursec', $parent.find('>a').attr('href'));
		},
